...
-- Auth client user
CREATE USER "auth_client_user";
ALTER USER auth_client_user WITH PASSWORD 'pass';
CREATE DATABASE "auth_client" ENCODING 'UTF8' LC_COLLATE = 'en-US' LC_CTYPE = 'en-US' TEMPLATE template0;
GRANT ALL PRIVILEGES ON DATABASE auth_client TO "auth_client_user";
